...
# 2026 연암공과대학교 스마트소프트웨어학과 소프트웨어공학 교과목 실습 프로젝트
...
### ✨ 해결 방안
본 프로젝트는 이러한 불편을 해소하기 위해 **"세탁기/건조기 실시간 현황 조회 시스템"**을 구축합니다.
사용자가 스마트폰(Android)을 통해 생활실에서도 기계의 상태를 즉시 파악하고, 효율적으로 세탁 시간을 관리할 수 있는 환경을 제공하고자 합니다.

---

### 🚀 주요 기능 (Key Features)
실시간 기기 상태 조회: 모든 세탁기/건조기의 가동 여부를 실시간 확인
...
| :---: | :---: | :---: | :---: |
| [안지호](https://github.com/anyway3) | [정훈민](https://github.com/hunmin121) | [한영진div align="center">
